...
import nn.ui.color.NNPlotColor;
...
abstract class Plot {
     ...
     * The nn.data padding is a factor. 0.1 would mean that between every axis and the plot nn.data, a space of
     ...
     * @param dataPadding nn.data padding within plot as factor (1.0 = 100%).
