...
/**
 * This class allows an easy handling of the nn.genetic algorithm. It will prepare according populations and allows processing generation by generation.
...
public class GeneticAlgorithmBatch<T> {
    ...
    /**
     * Constructor to create a new batch. With given parameters, the nn.genetic algorithm will be able to run.
     * It additionally loads the neuralnetwork.properties file from the resources, which can be configured
     * to modify the nn.genetic algorithm.
     *
     * @param templateGeneticAlgorithmObject the type which implements the actual logic of the nn.genetic algorithm.
     * @param seedNeuralNetwork              the NeuralNetwork to be seeded for the first population.
     * @param populationSize                 the population size for the nn.genetic algorithm.
     */
    ...
    /**
     * Constructor to create a new batch. With given parameters, the nn.genetic algorithm will be able to run.
     * It additionally loads the neuralnetwork.properties file which can be configured to modify the nn.genetic algorithm.
     *
     * @param templateGeneticAlgorithmObject the type which implements the actual logic of the nn.genetic algorithm.
     * @param seedNeuralNetwork              the NeuralNetwork to be seeded for the first population.
     * @param populationSize                 the population size for the nn.genetic algorithm.
    ...
    /**
     * Returns current reproduction pool size for the nn.genetic algorithm. Must not match corresponding property.
     *
    ...
    /**
     * Sets reproduction pool size for the nn.genetic algorithm.
     *
     * @param reproductionPoolSize the count of neural networks to be merged for reproduction.
     * @return the current nn.genetic algorithm batch.
     */
