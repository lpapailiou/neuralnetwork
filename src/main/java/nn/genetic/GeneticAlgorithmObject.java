...
/**
 * This abstract class can be used as superclass for an easy implementation of a nn.genetic algorithm object.
 * Such instance will handle the collection of nn.data for computer vision, feed it to the NeuralNetwork it holds,
...
public abstract class GeneticAlgorithmObject implements IGeneticAlgorithmObject {
    ...
    /**
     * This method will allow to extract the NeuralNetwork for the nn.genetic algorithm.
     *
     ...
     * nn.genetic algorithm throughout multiple generations. It will be used to compare this instance with other
    ...
    /**
     * This method indicates if this instance is in an immature state yet. In mature statues only, the nn.genetic
     ...
     * messages, so the progress of the nn.genetic algorithm can be supervised more easily.
     *
