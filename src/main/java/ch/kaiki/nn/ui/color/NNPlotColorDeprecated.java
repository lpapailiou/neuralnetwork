...
public class NNPlotColorDeprecated {
    ...
    public NNPlotColorDeprecated(Color backgroundColor, Color plotBackgroundColor, Color plotAxisColor, Color plotGridColor, Color plotTextColor, Color plotDataColor) {
    ...
    public NNPlotColorDeprecated(Color backgroundColor, Color plotAxisColor, Color plotTextColor) {
