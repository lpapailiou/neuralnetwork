...
public class RenderTest extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try {
            ...
            NeuralNetwork net = new NeuralNetwork.Builder( 2, 15, 15, 1).setInitializer(Initializer.KAIMING)
                    .setLearningRate(0.8)
            ...
            plot.setColorPalette(new NNPlotColorDeprecated(BLACK, BLACK, LIGHTGRAY, LIGHTGRAY, LIGHTGRAY, RED));
